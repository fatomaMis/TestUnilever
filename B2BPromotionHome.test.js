describe('B2B Promotion', function () {
    ...
    it('Test Case :Promotion', function () {
        //login 1
       ...
       expect(price2).toContain('50.00 EGP');
      ...
      expect(priceDel).toContain('50.00 EGP');
   ...
   element.all(by.className('collection-item')).then(function(op){
    ...
    expect(price11).toContain('9.00 EGP');

    //check original price
    var priceDel =  element(by.tagName('del')).getText();
    expect(priceDel).toContain('10.00 EGP');
    ...
    browser.getAllWindowHandles().then(function(handles) {
     ...
     //price after promotion
     var priceUser2 = element(by.className('price price2 no-margin')).getText();
     expect(priceUser2).toContain('9.00 EGP');

     //price pre promotion
     var priceUserDel = element(by.tagName('del')).getText();
     expect(priceUserDel).toContain('10.00 EGP');
